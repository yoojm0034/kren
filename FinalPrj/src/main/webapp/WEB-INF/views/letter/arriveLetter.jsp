		...
		<div class="inbox-wrapper-inner">
			...
			<div class="inbox-left-sidebar">
				<div class="inbox-left-sidebar-inner ">
					...
					<!-- Menu -->
					<div class="left-menu">
						<a href="letterBox.do" class="item">  <span class="name">New Letters</span>
						</a> <a href="arriveLetter.do" class="item is-active">   <span class="name">Arrive Letters!</span>
						</a> <a href="savedLetter.do" class="item">  <span class="name">Saved
								Letters</span>
						</a>
					</div>
					<!-- Mobile only close -->
